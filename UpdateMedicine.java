...
{
	JFrame jf;
	JTextField t1,t2,t4,t5,t6,t7,t8,t11,t12;
	JLabel l1,l2,l4,l5,l6,l7,l8,l11,l12,ln;
    JButton b0,b1,b2,b3;
  ...
  l6.setBounds(50,300,260,25);
		...
		//l7.setFont(f);
  l7.setBounds(470,180,200,25);
    	jf.add(l7);

        t7 = new JTextField(20);
		t7.setBounds(720,180,100,25);t7.setToolTipText("Enter medicine type");
		jf.add(t7);
		...
		tabtype.setBounds(600,180,100,25);tabtype.setToolTipText("Select medicine type");
		jf.add(tabtype);
...
//l10.setBounds(470,220,200,25);
	...
	//	l12.setFont(f);
 l12.setBounds(470,220,180,25);
    	jf.add(l12);

    	t12 = new JTextField(20);
	    t12.setBounds(720,220,100,25);
	    jf.add(t12);
 ...
 public void actionPerformed(ActionEvent ae)
  {
  	if(ae.getSource()==b0)
	  {
	   ...
	   try
	    {
	    	if(((t1.getText()).equals(""))||((t2.getText()).equals(""))||((t4.getText()).equals(""))||((t5.getText()).equals(""))||((t6.getText()).equals(""))||((t7.getText()).equals(""))||((t8.getText()).equals(""))||((t11.getText()).equals("")))
	        {
...
String str1="UPDATE medicine SET mbno='"+t1.getText()+"',mname='"+t2.getText()+"',mqty='"+t4.getText()+"',mexpdate='"+t5.getText()+"',mpurdate='"+t6.getText()+"',mtype='"+t7.getText()+"',mpurprice='"+t8.getText()+"',sid='"+t12.getText()+"',sname='"+t11.getText()+"' where mbno='"+t1.getText()+"'or mname='"+t2.getText()+"'";
