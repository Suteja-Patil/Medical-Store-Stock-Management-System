...
l1.setBounds(50,140,200,25);
		...
		t1.setBounds(250,140,100,25);t1.setToolTipText("Enter medicine batch no to delete medicine");
		jf.add(t1);
  ...
  l2.setBounds(50,180,200,25);
		...
		t2.setBounds(250,180,200,25);t2.setToolTipText("Enter medicine name to delete medicine");
		jf.add(t2);
...
public void actionPerformed(ActionEvent ae)
{
    ...
    {//list
     ...
     {
         Class.forName("com.mysql.jdbc.Driver");
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medical_store","root","rotpasswordgiven");
		System.out.println("Connected to database.");
